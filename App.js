  ...
  render() {
    return (
      <div className="App">
        ...
        <CategorySelector
          onChange={term => this.appHandleSubmit(term)}
          searchTerm={this.state.searchTerm}
          cardSet={this.state.setStyle}
          cardSetClick={() => this.cardSet()}
          cardClassClick={() => this.cardClass()}
          cardClass={this.state.classStyle}
          cardRarityClick={() => this.cardRarity()}
          cardRarity={this.state.rarStyle}
        />
